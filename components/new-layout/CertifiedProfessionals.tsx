  ...
  return (
    <div id="our-team" className="w-full bg-[#f4f7fb] py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-extrabold text-[#020d1f] tracking-tight mb-2 uppercase">13 Certified Professionals</h2>
        <p className="text-gray-500 mb-12 text-lg text-center sm:text-left">Our team of Registered Nurses are highly trained and ready to help you thrive.</p>
